...
#include "AnimNodeBaseCtrl.generated.h"

class USkeletalMeshComponent;

USTRUCT(BlueprintInternalUseOnly)
struct ANIMATIONMNG_API FAnimNodeBaseCtrl : public FAnimNode_Base
{
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Alpha, meta = (NeverAsPin))
	float Alpha;
