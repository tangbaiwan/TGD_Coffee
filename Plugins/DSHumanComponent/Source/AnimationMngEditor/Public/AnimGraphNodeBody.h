...
#include "AnimGraphNodeBody.generated.h"

class FCompilerResultsLog;

UCLASS(meta=(Keywords = "Modify Body"))
class ANIMATIONMNGEDITOR_API UAnimGraphNodeBody : public UAnimGraphNodeBaseCtrl
{
...
protected:
	...
	virtual const FAnimNodeBaseCtrl* GetNode() const override { return &Node; }
