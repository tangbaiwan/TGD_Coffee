...
#include "AnimGraphNodeBaseCtrl.generated.h"

class FCompilerResultsLog;
class USkeletalMeshComponent;
struct FAnimNodeBaseCtrl;
struct HActor;
 ...
 *
 * Concrete subclasses should contain a member struct derived from FAnimNodeBaseCtrl
 */
UCLASS(Abstract)
class ANIMATIONMNGEDITOR_API UAnimGraphNodeBaseCtrl : public UAnimGraphNode_Base
{
...
public:
	...
	virtual FVector GetWidgetLocation(const USkeletalMeshComponent* SkelComp, struct FAnimNodeBaseCtrl* AnimNode)
	{
	...
	UE_DEPRECATED(4.14, "This function is deprecated. Use a IAnimNodeEditMode-derived class to implement a new editor mode and override GetEditorMode to return its ID")
	virtual void MoveSelectActorLocation(const USkeletalMeshComponent* SkelComp, FAnimNodeBaseCtrl* InAnimNode) {}
...
protected:
	...
	*/
	...
	virtual const FAnimNodeBaseCtrl* GetNode() const PURE_VIRTUAL(FAnimNodeBaseCtrl::GetNode, return nullptr;);
};
